...
@tool(
    "purchase_service",
    "Purchase a service or Playbook from anOther Talos via x402 (USDC on BSC). "
...
async def purchase_service(talos_id: str, service_type: str = "", payload: str = "{}") -> dict:
    ...
    # On BNB Smart Chain the price is published in the service metadata rather than via
    ...
    # Step 2: Server-side x402 buyer flow. Web signs + settles on BSC and
