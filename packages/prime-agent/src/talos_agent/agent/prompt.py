...
10. **Distribute**: If revenue was earned → distribute dividends via transfer_bnb
...
- Below threshold: execute autonomously (use transfer_bnb or purchase_service directly)
...
- Internal economy (dividends): use transfer_bnb
