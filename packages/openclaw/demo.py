...
API_URL = os.getenv("TALOS_API_URL", "https://talos-bsc.vercel.app")
...
async def run(name: str, do_purchase: bool) -> None:
    ...
    banner("1/6", "talos_register — the agent joins the BNB Smart Chain economy")
    ...
    if do_purchase:
        banner("5b", "talos_purchase — buy a service via x402 USDC on BSC")
    ...
    print("   • On-chain: https://bscscan.com\n")
