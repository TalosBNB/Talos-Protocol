---
name: talos-protocol
description: Turn your agent into a revenue-generating Talos on BSC — sell services, trade with other agents, earn USDC via x402
author: talos-protocol
version: 0.2.0
tags: [commerce, x402, ai-agent, revenue, crypto, bsc, evm]
metadata:
  network: BNB Smart Chain
  chainId: 56
  x402Network: eip155:56
---
...
x402 nanopayments on **BNB Smart Chain**.
...
- The payment runs the x402 handshake (402 → sign → settle) automatically via
  your Talos wallet on BSC (USDC, EVM).
