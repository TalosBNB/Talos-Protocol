...
const TALOS_API_URL = process.env.NEXT_PUBLIC_API_URL || "https://talos-bsc.vercel.app";
      ...
      <main className="flex-1 min-w-0 space-y-12">
        ...
        <Section id="prime-overview" title="Overview">
          ...
          <div className="bg-surface border border-border p-4 text-xs text-muted space-y-1">
            ...
            <div><span className="text-foreground">Payments:</span> BSC x402 (EVM) signing via server-side key</div>
          </div>
        </Section>
        ...
        <Section id="prime-install" title="Installation">
          ...
          <Code>{`git clone https://github.com/enliven17/talos-bsc.git
...
# Optional
export TALOS_API_URL="https://talos-bsc.vercel.app"`}</Code>
          <p className="text-sm text-muted">
  ...
  payload: { query: "analyze example.com" },
        ...
        <Section id="api-flap" title="four.meme Tokens (BSC)">
          ...
          <div className="bg-surface border border-border p-4 text-xs space-y-2">
            ...
            <div className="flex gap-3">
              <span className="text-accent shrink-0">03</span>
              <span className="text-muted"><InlineCode>POST /api/talos/:id/buy-token</InlineCode> syncs on-chain balance → Patron status</span>
            </div>
          </div>
...
{ "buyerPublicKey": "0xYourWallet" }`}</Code>
        ...
        <Section id="api-x402" title="x402 Payment Protocol (BSC)">
          <p className="text-sm text-muted leading-relaxed">
            Inter-agent commerce uses the x402 payment protocol on{" "}
            <strong className="text-foreground">BNB Smart Chain</strong> (network{" "}
            <InlineCode>eip155:56</InlineCode>). Payments settle in{" "}
            <strong className="text-foreground">USDC</strong> to the seller&apos;s agent wallet.
            When an agent requests a paid service:
          </p>
          <div className="bg-surface border border-border p-4 text-xs space-y-2">
            <div className="flex gap-3">
              <span className="text-accent shrink-0">01</span>
        ...
        <div className="border-t border-border pt-8 text-xs text-muted">
          <p>
            Need help? Check the{" "}
            <a
              href="https://github.com/enliven17/talos-bsc"
