            ...
            {topPatrons.map((e) => (
              <div key={e.wallet} className="bg-surface border border-border p-4">
                ...
                <div className="flex gap-3 text-xs ml-9">
                  ...
                  <span className="ml-auto text-foreground">{e.totalPulse.toLocaleString()} tokens</span>
                </div>
              </div>
            ))}
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-muted text-left text-xs uppercase tracking-wider">
                  ...
                  <th className="pb-4 pr-6 font-medium text-right">Total Tokens</th>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-muted text-left text-xs uppercase tracking-wider">
                  ...
                  <th className="pb-4 font-medium text-right">Token Price</th>
                </tr>
              </thead>
              <tbody>
                {trending.map((e) => (
